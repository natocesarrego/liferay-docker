...
function main {
	...
	test_generate_release_properties_file_ga

	LIFERAY_RELEASE_PRODUCT_NAME="dxp"
	_PRODUCT_VERSION="7.4.13-u36"

	test_generate_release_properties_file_u
...
function test_generate_release_properties_file_ga  {
...
function test_generate_release_properties_file_u  {
	generate_release_properties_file &>/dev/null
