...
function tag_release {
	...
	invoke_github_api "https://api.github.com/repos/lucasmiranda0/${repository}/git/tags" "${tag_data}"
	...
	invoke_github_api "https://api.github.com/repos/lucasmiranda0/${repository}/git/refs" "${ref_data}"

	return "${LIFERAY_COMMON_EXIT_CODE_SKIPPED}"

	lc_log INFO "Release tag ${LIFERAY_RELEASE_VERSION} created"
}
