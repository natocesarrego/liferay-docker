...
function check_supported_versions {
	local supported_version="${LIFERAY_RELEASE_VERSION%.*}"
...
function tag_release {
	...
	invoke_post_github_api "https://api.github.com/repos/liferay/${repository}/git/tags" "${tag_data}"
	...
	invoke_post_github_api "https://api.github.com/repos/liferay/${repository}/git/refs" "${ref_data}"
