...
function tag_release {
	...
	invoke_github_post_api "https://api.github.com/repos/liferay/${repository}/git/tags" "${tag_data}"
	...
	invoke_github_post_api "https://api.github.com/repos/liferay/${repository}/git/refs" "${ref_data}"
