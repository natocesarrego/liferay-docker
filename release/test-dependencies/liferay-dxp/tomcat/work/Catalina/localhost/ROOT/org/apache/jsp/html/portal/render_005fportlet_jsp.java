...
private static final Log _log = LogFactoryUtil.getLog("portal_web.docroot.html.portal.render_portlet_jsp");
  ...
  static {
    ...
    _jspx_dependants.put("/html/portal/render_portlet-ext.jsp", Long.valueOf(1721635518884L));
...
Boolean renderPortletBoundary = GetterUtil.getBoolean(request.getAttribute(WebKeys.RENDER_PORTLET_BOUNDARY), true) && !themeDisplay.isStateExclusive() && portlet.isInclude();
      ...
      try {
        ...
        // /html/portal/render_portlet.jsp(851,0) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
	...
	if ((portletVisibility != null) && !layout.isTypeControlPanel()) {
      ...
      try {
        ...
        // /html/portal/render_portlet.jsp(903,0) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          ...
          try {
            ...
            if (_jspx_eval_c_005fchoose_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              try {
                ...
                // /html/portal/render_portlet.jsp(926,2) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if (portletDisplay.isShowMoveIcon()) {
	...
	if (portlet.isStaticEnd()) {
        ...
        if (_jspx_eval_aui_005fscript_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            try {
              ...
              // /html/portal/render_portlet.jsp(959,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        // /html/portal/render_portlet.jsp(976,0) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        // /html/portal/render_portlet.jsp(980,0) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_c_005fif_005f4.setTest( themeDisplay.isStatePopUp() );
	...
	String refreshPortletId = null;
          ...
          try {
            ...
            // /html/portal/render_portlet.jsp(986,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            _jspx_th_c_005fif_005f5.setTest( (refreshPortletId = (String)SessionMessages.get(liferayRenderRequest, portletId + SessionMessages.KEY_SUFFIX_REFRESH_PORTLET)) != null );
                ...
                if (_jspx_eval_aui_005fscript_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  do {
                    ...
                    try {
                      ...
                      // /html/portal/render_portlet.jsp(1002,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                      _jspx_th_c_005fif_005f6.setTest( (refreshPortletData != null) && !refreshPortletData.isEmpty() );
	...
	String closeRedirect = null;
          ...
          try {
            ...
            // /html/portal/render_portlet.jsp(1025,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            _jspx_th_c_005fif_005f7.setTest( (closeRedirect = (String)SessionMessages.get(liferayRenderRequest, portletId + SessionMessages.KEY_SUFFIX_CLOSE_REDIRECT)) != null );
	...
	String closeRefreshPortletId = null;
          ...
          try {
            ...
            // /html/portal/render_portlet.jsp(1068,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            _jspx_th_c_005fif_005f8.setTest( (closeRefreshPortletId = (String)SessionMessages.get(liferayRenderRequest, portletId + SessionMessages.KEY_SUFFIX_CLOSE_REFRESH_PORTLET)) != null );
                ...
                if (_jspx_eval_aui_005fscript_005f3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  do {
                    ...
                    try {
                      ...
                      // /html/portal/render_portlet.jsp(1092,7) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                      _jspx_th_c_005fif_005f9.setTest( (refreshPortletData != null) && !refreshPortletData.isEmpty() );
