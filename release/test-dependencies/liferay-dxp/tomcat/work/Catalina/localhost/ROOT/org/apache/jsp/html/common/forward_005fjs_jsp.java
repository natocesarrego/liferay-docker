...
public final class forward_005fjs_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/html/common/forward_common.jsp", Long.valueOf(1721635518876L));
...
if (!CookiesManagerUtil.hasSessionId(request) && Validator.isNotNull(forwardURL)) {
	forwardURL = PortalUtil.getURLWithSessionId(forwardURL, session.getId());
      ...
      try {
        ...
        // /html/common/forward_js.jsp(10,0) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
