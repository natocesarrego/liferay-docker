...
public final class referer_005fjs_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/html/common/referer_common.jsp", Long.valueOf(1721635518876L));
  ...
  static {
    ...
    _jspx_imports_classes = new java.util.LinkedHashSet<>(155);
...
if ((httpSession != null) && !CookiesManagerUtil.hasSessionId(request) && Validator.isNotNull(referer)) {
	referer = PortalUtil.getURLWithSessionId(referer, httpSession.getId());
      ...
      try {
        ...
        // /html/common/referer_js.jsp(16,0) name = position type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_aui_005fscript_005f0.setPosition("inline");
        // /html/common/referer_js.jsp(16,0) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
