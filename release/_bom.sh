...
function generate_pom_release_api {
	...
	sed \
		-e "s/__LIFERAY_RELEASE_PRODUCT_NAME__/release.${LIFERAY_RELEASE_PRODUCT_NAME}.api/" \
...
function generate_pom_release_bom {
	...
	sed \
		-e "s/__LIFERAY_RELEASE_PRODUCT_NAME__/release.${LIFERAY_RELEASE_PRODUCT_NAME}.bom/" \
		-e "s/__BUILD_TIMESTAMP__/${_BUILD_TIMESTAMP}/" \
		-e "s/__PRODUCT_VERSION__/${_PRODUCT_VERSION}/" \
		-e "w ${pom_file_name}" \
...
function generate_pom_release_bom_compile_only {
	...
	sed \
		-e "s/__LIFERAY_RELEASE_PRODUCT_NAME__/release.${LIFERAY_RELEASE_PRODUCT_NAME}.bom.compile.only/" \
		-e "s/__BUILD_TIMESTAMP__/${_BUILD_TIMESTAMP}/" \
		-e "s/__PRODUCT_VERSION__/${_PRODUCT_VERSION}/" \
		-e "w ${pom_file_name}" \
...
function generate_pom_release_bom_third_party {
	...
	sed \
		-e "s/__LIFERAY_RELEASE_PRODUCT_NAME__/release.${LIFERAY_RELEASE_PRODUCT_NAME}.bom.third.party/" \
		-e "s/__BUILD_TIMESTAMP__/${_BUILD_TIMESTAMP}/" \
		-e "s/__PRODUCT_VERSION__/${_PRODUCT_VERSION}/" \
		-e "w ${pom_file_name}" \
