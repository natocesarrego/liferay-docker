...
function generate_api_jars {
	...
	local tld_names=("liferay-*.tld" "ratings.tld")

	_copy_tld "${tld_names[@]}" "api-jar/META-INF"

	mkdir -p api-jar/META-INF/resources/WEB-INF

	tld_names=("liferay-application-list.tld" "liferay-data-engine.tld" "liferay-ddm.tld" "liferay-export-import-changeset.tld" "liferay-form.tld" "liferay-staging.tld" "liferay-template.tld"  "react.tld" "soy.tld")

	_copy_tld "${tld_names[@]}" "api-jar/META-INF/resources"

	tld_names=("liferay-*.tld" "ratings.tld" "react.tld" "soy.tld")

	_copy_tld "${tld_names[@]}" "api-jar/META-INF/resources/WEB-INF"
}
