...
function generate_api_jars {
	...
	local tld_files=($(find "${_PROJECTS_DIR}" -name "liferay-*.tld" -o -name "ratings.tld" -type f | awk -F/ '{print $NF, $0}' | sort -k1,1 -u | awk '{print $2}'))

	for file in "${tld_files[@]}"
	do
	...
	tld_files=($(find "${_PROJECTS_DIR}" -name "liferay-application-list.tld" -o -name "liferay-data-engine.tld" -o -name "liferay-ddm.tld" -o -name "liferay-export-import-changeset.tld" -o -name "liferay-form.tld" -o -name "liferay-staging.tld" -o -name "liferay-template.tld" -o -name "react.tld" -o -name "soy.tld" -type f | awk -F/ '{print $NF, $0}' | sort -k1,1 -u | awk '{print $2}'))
	...
	tld_files=($(find "${_PROJECTS_DIR}" -name "liferay-*.tld" -o -name "ratings.tld" -o -name "react.tld" -o -name "soy.tld" -type f | awk -F/ '{print $NF, $0}' | sort -k1,1 -u | awk '{print $2}'))
